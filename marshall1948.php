...
$rec_list = mysql_query ("select ev,portugal, izland, ir, uk, norveg, sved, dan, belga, svajc, holland, nszk, ausztria, olasz, jugoszlav, gorog, torok, francia, total from eukoltseg_tab where ev ='1948' ") or die ("Hiba a kérésben -> ".mysql_error()); 
$i = 1; 
